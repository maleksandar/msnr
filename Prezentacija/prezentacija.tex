...
% \newcommand{\iter}{\textbf{\textsc{Iterativna kompilacija}} \xpace}
...
% \section{Šta je iterativna kompilacija?}
...
\begin{frame}[fragile]{Šta je iterativna kompilacija?}
  ...
  {\textbf{\textsc{Iterativna kompilacija}}\xspace} je metoda pronalaženja ulaznih parametara statičkih transformacija
   koda koji proizvode kod sa najboljim performansama pri izvršavanju prevedenog programa.
...
\begin{frame}[fragile]{Šta je iterativna kompilacija?}
  \begin{itemize}[<+- | alert@+>]
    \item \textbf{Metoda} korišćenja kompajlera
...
% \section{Zašto koristiti iterativnu kompilaciju?}
...
% \section{Kako implementirati metod iterativne kompilacije?}
\begin{frame}[standout]
