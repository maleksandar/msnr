...
\textbf{Pretraga mreže} (eng. grid search) \cite{bergstra2012random,knijnenburg2002iterative}. Predstavlja tradicionalni pristup problemu optimizacije većeg broja parametara (eng. hyperparameter optimization). 
...
sporija od programa dobijenih prvom metodom. U slučaju MxM vidimo da je program kompiliran sa 3 različite veličine 
