...
\label{sec:perpod1}
  Ovde ćemo izneti rezultate dobijene u [!!] koji prikazuju uticaj iterativne kompilacije na brzinu izvršavanja programa.
...
tako prevedenih programa je prikazano na slikama \ref{fig:slika1} gde je koršćen prvi skup optimizacionih tehnika i 
\ref{fig:slika2} gde je korišćen drugi skup optimizacionih tehnika. Iz rezultata prikazanih na slici \ref{fig:slika1} vidimo da
